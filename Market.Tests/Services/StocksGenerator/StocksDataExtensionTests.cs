...
namespace StocksAPI.Tests.Services.StocksRetrieval
{
    public class StocksExtensionTests
    {
        ...
        public void When_ConventionalPriceIsCalled_Then_2DigitsAfterTheValueReturned(float price, decimal decimalPrice)
        {
            // Arrange
        ...
        [Fact]
        public void When_ConventionalDataTimeCalled_Then_StandardizedDateIsReturned()
        {
            // Arrange
            DateTime date = new();
